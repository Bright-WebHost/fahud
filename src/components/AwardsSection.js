...
export default function AwardsSection() {
  return (
    <div className="section-full twm-achi-section-wrap p-t120 p-b90" style={{ backgroundImage: `url(${assetPrefix}/images/background/count-bg.jpg)` }}>
          ...
          <ul className="flex flex-fd-c flex-jc-sb">
            ...
            <li>
              <div className="twm-achi-bx-conent">
                ...
                <div className="hover-reveal image01">
                  <img className="hidden-img" src={`${assetPrefix}/images/award/pic1.jpg`} alt="pic1" />
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="twm-achi-bx-conent">
                ...
                <div className="hover-reveal image02">
                  <img className="hidden-img" src={`${assetPrefix}/images/award/pic2.jpg`} alt="pic2" />
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="twm-achi-bx-conent">
                ...
                <div className="hover-reveal image03">
                  <img className="hidden-img" src={`${assetPrefix}/images/award/pic3.jpg`} alt="pic3" />
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="twm-achi-bx-conent">
                ...
                <div className="hover-reveal image04">
                  <img className="hidden-img" src={`${assetPrefix}/images/award/pic4.jpg`} alt="pic4" />
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="twm-achi-bx-conent">
                ...
                <div className="hover-reveal image04">
                  <img className="hidden-img" src={`${assetPrefix}/images/award/pic5.jpg`} alt="pic5" />
                </div>
              </div>
            </li>
          </ul>
